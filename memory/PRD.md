...
### CORRECCIÓN DE DESCARGA PDF REPORTADA EN PRODUCCIÓN — 2026-09-23

- Se analizó el PDF real `carnet-miembro-Damaris-Bell.pdf`: MediaBox CR80 era correcto, pero html2canvas omitía SVG de fondo y recortaba tipografía serif con `overflow:hidden`.
- PDF corregido: capas SVG se rasterizan temporalmente a PNG de alta resolución antes de html2canvas y se restauran después; dos descargas consecutivas producen raster idéntico.
- Resoluciones físicas normalizadas: carnet 2764 × 1743 px dentro de 85.60 × 53.98 mm; certificado 2112 × 1632 px dentro de 11 × 8.5 in.
- Carnet: nombre completo sin recorte, cargo actual visible bajo el nombre, estado separado, fecha termina antes de bandas, cruz con tallo inferior largo y QR solo en reverso.
- Certificado: nombre y texto completos, curvas SVG extendidas fuera del viewBox para llegar al borde físico y QR verificable.
