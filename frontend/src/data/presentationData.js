...
export const SLIDES = [
  // ----- 1. PORTADA -----
  {
    ...
    notes: {
      abrir: 'Hay momentos en la vida de una iglesia que no se repiten dos veces. Este es uno de esos momentos. Llevamos meses estudiando esta visión en oración y ayuno, y hoy la lanzamos juntos como casa de oración.',
      decir: [
        'Lo que vamos a abrir hoy no es un manual más para el archivero: es una puerta espiritual que Dios nos ha mostrado tras meses de búsqueda.',
        'Dios no nos llamó a sobrevivir religiosamente cada domingo. Nos llamó a edificar generacionalmente con un modelo claro y replicable que comienza HOY.',
        'Vamos a recorrer juntos el QUÉ, el CÓMO y CUÁL es tu rol específico. Nadie sale de aquí sin saber su puerta y su próximo paso.',
      ],
      ilustrar: 'Hay personas que toda su vida han estado cerca del fuego de Dios y nunca se calentaron. Estaban en el culto pero no en la presencia. Hoy te invito a acercarte tanto al fuego, que cuando salgas de este lugar, los que te conocen noten algo diferente en tu rostro y en tus decisiones.',
      preguntar: '¿Vas a recibir esto como una capacitación más que se agrega a tu calendario... o como el momento que parte tu año en dos y marca a la generación que viene detrás de ti?',
      aplicar: 'Ahora mismo, antes de seguir, escribe tu nombre completo en la primera página de este manual y la fecha de hoy. Esa firma no es trámite: es pacto entre tú y Dios. Quien firma, se compromete.',
      transicion: 'Antes de caminar por el sistema, revisemos el mapa completo. Porque todos los que llegan lejos, primero saben hacia dónde van.',
  ...
  // ----- 2. INDICE -----
  {
    ...
    notes: {
      abrir: 'Antes de hablar de fruto, hablemos de raíz. Antes de la raíz, miremos el mapa. Y antes del mapa, despertemos el hambre de recorrerlo completo como iglesia unida.',
      decir: [
        'Este índice no es decoración. Es la ruta que Dios trazó paso a paso para esta iglesia en este nuevo tiempo que comienza hoy.',
        'Son 29 páginas divididas en 4 partes: Fundamentos, las 9 Puertas, Liderazgo y Estrategia. Ninguna parte se salta. Ninguna sobra.',
        'Lo que hoy parece complicado, en 6 semanas será nuestro lenguaje natural. Vamos a hablar de Puerta 3 como hablamos de nuestra casa.',
      ],
      ilustrar: 'Una iglesia sin índice escrito cae en activismo: muchas reuniones, mucho movimiento, mucho cansancio, poco fruto medible. Hoy rompemos ese ciclo escribiendo paso por paso adónde vamos.',
      preguntar: '¿Cuántas veces hemos empezado algo importante en el ministerio sin saber adónde íbamos exactamente? Eso se acaba en esta página, hoy, en este momento.',
      aplicar: 'Pasa el dedo por las 4 secciones del índice. Marca con un asterisco la parte que más curiosidad despierta en tu corazón. Esa es la parte por la que Dios te trajo hoy. La leerás esta misma semana.',
      transicion: 'Ahora levantamos la mirada del índice al llamado. Antes del sistema, está la invitación divina.',
    },
  },
  ...
  // ----- 4. PARA QUIEN + PROMESA -----
  {
    ...
    notes: {
      abrir: 'Si estás en este lugar hoy, este manual es para TI. No te lo regalaron por casualidad. Dios te lo entregó con un propósito que vamos a definir esta noche.',
      decir: [
        'Lo vas a leer con tres herramientas: lápiz en la mano, oración en el corazón y tu equipo al lado. Esa combinación es la que cambia ministerios.',
        'Tres acciones obligatorias mientras lees: subrayar lo que impacta, marcar con asterisco lo que vas a implementar y poner signo de pregunta a lo que te desafía.',
        'La promesa es directa: si aplicamos con disciplina cada parte, en 90 días veremos fruto medible. No por el manual: porque Dios honra los principios que están adentro.',
      ],
      ilustrar: 'El pastor lo lee como pastor y reorganiza su visión. El mentor lo lee como mentor y mejora su discipulado. El servidor lo lee como servidor y descubre cuál es su puerta. El nuevo creyente lo lee y entiende su proceso completo. Cada quien encuentra su nombre en estas páginas.',
      preguntar: '¿Vas a leerlo una sola vez como una novela en una tarde... o lo vas a usar como herramienta de trabajo todos los lunes durante todo el año?',
      aplicar: 'Define HOY mismo, antes de salir de aquí, desde qué rol vas a leer este manual. Escríbelo en la primera página junto a tu nombre. Opciones: pastor, líder, mentor, servidor o nuevo creyente. Esa decisión define todo.',
      transicion: 'Antes de los detalles, miremos la fotografía completa del sistema en una sola página.',
    },
  },
  ...
  // ----- 5. INTRO MANUAL -----
  {
    ...
    notes: {
      abrir: 'Hay una forma vieja de ver la iglesia, basada en programas y eventos sueltos. Y hay una forma nueva, basada en procesos y personas. Esta página te invita a abrir los ojos del espíritu y ver con la nueva.',
      decir: [
        'Cinco pilares sostienen el sistema completo: el corazón (visión, misión, valores), la base bíblica, el proceso claro, las herramientas prácticas y la estrategia de ganar.',
        'No basta con tener corazón: hay que tener proceso. No basta con tener proceso: hay que tener herramientas. Y nada de eso vale sin estrategia que mida resultados.',
        'Cada pilar sostiene a los demás como las patas de una silla. Si quitamos uno, el sistema entero se cae al suelo. Por eso Dios pidió los cinco, no algunos.',
      ],
      ilustrar: 'Hay vidas concretas esperando ser ALCANZADAS con un mensaje. Hay sueños esperando ser ACTIVADOS con una palabra de fe. Hay puertas espirituales esperando ser ABIERTAS con tu obediencia. La iglesia es la mano que Dios usa para abrir esas puertas a otros.',
      preguntar: '¿Cuál de los cinco pilares está más débil hoy en tu área? Si no puedes responder en 5 segundos, ahí está tu primera tarea concreta de la semana.',
      aplicar: 'Esta semana, identifica el pilar más débil de tu área por escrito. Antes del próximo viernes, da UN paso concreto para fortalecerlo y manda una foto de evidencia al líder de tu puerta.',
      transicion: 'Empezamos por el primer pilar: el corazón del sistema. Nuestra identidad como iglesia.',
    },
  },
  ...
  // ----- 6. NUESTRA IDENTIDAD -----
  {
    ...
    notes: {
      abrir: 'Antes de leer la pantalla, contesta esta pregunta en silencio: ¿quién soy yo cuando nadie de la iglesia me está viendo? Esa respuesta es tu identidad real, no la del slide.',
      decir: [
        'Nuestra VISIÓN es clara: levantar discípulos que se conviertan en líderes, a través de un sistema intencional que transforma vidas y se multiplica.',
        'Nuestra MISIÓN tiene cuatro verbos en orden estricto: evangelizar, consolidar, discipular y enviar. Saltarse cualquiera produce iglesias grandes pero débiles.',
        'Nuestros 7 VALORES son: 1) Presencia de Dios, 2) Amor por las almas, 3) Relaciones intencionales, 4) Formación continua, 5) Multiplicación, 6) Orden, 7) Excelencia. Estos no son adornos del lobby: son el filtro de cada decisión.',
      ],
      ilustrar: 'Si decimos que valoramos el orden y nuestra área es un caos, los valores son solo papel pintado. Si decimos que amamos las almas y no llamamos a un ausente en 30 días, el amor es solo discurso para los domingos.',
      preguntar: '¿Cuál de los 7 valores está más débil en tu área hoy? ¿Presencia de Dios, amor por las almas, relaciones, formación, multiplicación, orden o excelencia? Ahí está el punto exacto donde Dios quiere comenzar contigo.',
      aplicar: 'Esta semana, cada líder hace una hoja con los 7 valores en columna. Al lado de cada uno escribe SI o NO según cómo está su área. Donde haya 3 NO seguidos, ahí se enfoca el plan de los próximos 30 días.',
      transicion: 'La razón profunda detrás de todo este sistema no nació en una junta. Está escrita hace 2,500 años en Nehemías capítulo 3.',
    },
  },
  ...
  // ----- 7. LEMA · NEHEMIAS -----
  {
    ...
    notes: {
      abrir: 'Cosecha y Restitución. No es un eslogan bonito para una camiseta. Es un mandato profético que recibimos en oración. Y los mandatos no se decoran: se obedecen con fechas y resultados.',
      decir: [
        'Nehemías reconstruyó PRIMERO las puertas, antes que las casas y antes que el templo. Sin puertas no hay protección, ni orden, ni crecimiento sano.',
        'Asignó el trabajo POR ZONAS. Cada familia sabía exactamente qué pedazo del muro reconstruía y a quién protegía. Eso es estructura celular antes del Nuevo Testamento.',
        'Dios prometió devolver lo perdido y multiplicar el fruto cuando hay puertas reconstruidas. Esa promesa la estamos tomando para esta iglesia este mismo año.',
      ],
      ilustrar: 'En tiempos de Nehemías, los muros de Jerusalén estaban rotos por 70 años. Hoy nuestras puertas rotas son los procesos sin terminar, las llamadas que se quedan sin hacer y los discipulados que se cortan en la semana 4. Hay que reconstruir cada brecha.',
      preguntar: '¿Cuántas puertas espirituales en tu vida y en tu área están rotas hoy? ¿Y por cuánto tiempo más vamos a vivir con esas grietas abiertas dejando que el enemigo entre por ahí?',
      aplicar: 'Antes del próximo domingo, identifica UN área de tu ministerio que está rota. Escribe un plan de 30 días en una hoja con: meta, fecha de inicio, fecha de cierre y 3 acciones concretas. Pega esa hoja en tu agenda.',
      transicion: 'Ahora bajamos del lema profético al sistema concreto que vamos a ejecutar: la Ley de las 7 Semanas.',
    },
  },
  ...
  // ----- 8. LEY DE LAS 7 SEMANAS -----
  {
    ...
    notes: {
      abrir: 'Siete semanas. Un calendario sagrado. No siete deseos puestos en una lista, sino siete decisiones que, ejecutadas con disciplina, parten un año ministerial en dos.',
      decir: [
        'Cada semana tiene UN objetivo concreto: Preparación, Invasión, MCD, NPT, Liberación, Bendición, Sanidad. Saltarse una rompe el efecto dominó del proceso.',
        'Cinco principios sostienen este sistema: procesos continuos, eliminar vacíos espirituales, acción no solo teoría, disciplina en la ejecución y trabajo en equipo con un mismo objetivo.',
        'Como dice el manual: "La visión no es abstracta, es concreta; y lo concreto produce resultados." Esa es la regla que va a gobernar nuestras semanas.',
      ],
      ilustrar: 'Una semana sin propósito escrito equivale a un mes perdido en el calendario. Pero 7 semanas con objetivo claro y equipo activo producen lo que muchas iglesias no logran en 7 meses de actividad sin orden.',
      preguntar: '¿En qué semana del proceso suele caerse la gente (¿semana 3? ¿semana 5?), y qué vamos a hacer DIFERENTE esta vez para que no vuelvan a caer en el mismo punto?',
      aplicar: 'Antes de salir hoy, definimos la fecha exacta de inicio del primer ciclo de 7 semanas. Marcamos en el calendario los 7 lunes consecutivos. Ese será nuestro mapa visible cada mañana al despertar.',
      transicion: 'Y para conectar las 9 puertas con las 7 semanas, Dios nos dio un motor específico: el Modelo CAP.',
    },
  },
