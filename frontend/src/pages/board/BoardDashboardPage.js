...
export default function BoardDashboardPage() {
  const { API, getAuthHeaders } = useAuth(); const access = useBoardAccess(); const [data, setData] = useState(null); const [board, setBoard] = useState(null); const [loading, setLoading] = useState(true); const [error, setError] = useState('');
