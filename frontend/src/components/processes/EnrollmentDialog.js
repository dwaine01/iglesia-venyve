...
export const EnrollmentDialog = ({ processKey, cycles = [], assignees = [], onCreated, triggerLabel = 'Inscribir Persona' }) => {
  ...
  const submit = async (event) => {
    ...
    try {
      ...
      toast.success('Persona inscrita con su person_id canónico'); setOpen(false); setForm({ person_id: '', cycle_id: '', responsible_person_id: '', next_action: '', next_action_at: '' }); await onCreated();
